...
{
	internal class type5 : imageexpression
	{
		...
		public type5(Image f, lineexpression parent, Color color) : base(f, parent, color)
		{
		...
		public override void RefreshRegion(Graphics g)
		{
			...
			float num2 = base.GSize.Width + this.Xiabiao.Region.Width;
			float num3 = Math.Max(base.GSize.Height + this.Xiabiao.Region.Height / 2f, base.GSize.Height / 2f + this.Xiabiao.Region.Height);
		...
		{
			base.Benti.InputLocation = new PointF(base.InputLocation.X + base.GSize.Width + this.Xiabiao.Region.Width + 2f + 5f, base.InputLocation.Y + base.BaseLine - base.Benti.BaseLine);
			base.FuhaoLoc = new PointF(base.InputLocation.X + 2f, base.InputLocation.Y + base.BaseLine - base.FuhaoBaseLine);
			this.Xiabiao.InputLocation = new PointF(base.InputLocation.X + base.GSize.Width + 2f, base.FuhaoLoc.Y + base.GSize.Height - Math.Min(base.GSize.Height, this.Xiabiao.Region.Height) / 2f);
