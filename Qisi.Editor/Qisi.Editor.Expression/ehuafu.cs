...
namespace Qisi.Editor.Expression
{
	internal class ehuafu : dexpression
	{
		...
		public override void DrawExpression(Graphics g)
		{
			...
			g.DrawString("~", this.Font, solidBrush, (base.InputLocation.X + base.Benti.Region.Width / 2f - width * num / 2f) / num, base.InputLocation.Y - width / 3f * 2f, genericTypographic);
			g.ResetTransform();
			solidBrush.Dispose();
		}
	}
