...
namespace Qisi.Editor.Expression
{
	internal class jiankuohao : kuohaoexpression
	{
		...
		public override void DrawExpression(Graphics g)
		{
			...
			g.DrawLine(pen, base.InputLocation.X + base.Region.Width - 2f - base.GSize, base.InputLocation.Y + base.Region.Height, base.InputLocation.X + base.Region.Width - 2f, base.InputLocation.Y + base.Region.Height / 2f);
			pen.Dispose();
		}
	}
}
